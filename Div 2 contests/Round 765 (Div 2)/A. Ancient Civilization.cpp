...
// Problem link : https://codeforces.com/contest/1625/problem/A
// Contest : Codeforces Round #746 (Div. 2)
// Problem tags : greedy, easy
// TC : O(t*n)
// SC : O(n)
...
void solve()
{
	...
	for (auto &it: bits)
	{
		if (it>=mid) ans+=x;	// greedily choose whether to set or unset bit
		x<<=1;
	}
	cout<<ans;
}
